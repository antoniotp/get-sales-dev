...
class WhatsAppReadWebhookTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->message = Message::create([
            ...
            'sent_at' => now(),
            'delivered_at' => now(), // Assume it was delivered
            'read_at' => null,
            'failed_at' => null,
        ]);

        // Payload for a "read" status update
        $this->payload = [
    ...
    public function test_it_processes_a_read_status_webhook_and_updates_message(): void
    {
        // Assert initial state
        $this->assertNotNull($this->message->delivered_at); // Should be delivered first
        $this->assertNull($this->message->read_at);
        ...
        $this->assertNotNull($this->message->delivered_at); // Still delivered
        $this->assertNotNull($this->message->read_at);    // Now read
    }
}
